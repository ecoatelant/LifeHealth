...
class VuePatient {
    ...
    public function afficherCorpsSoins(){
        ...
        public function afficherExamens($soins){
...
<a href=\"index.php?module=patient&action=soinsFormulaire\"><input type=\"button\" value=\"Nouvel examen\"></a>


<table class=\"tftable\" border=\"1\">
<tr><th>Type d'examen</th><th>Zone corporel concerné</th><th>Date d'examen</th></tr>";

        $req=null;
        if(!empty($soins)){
            foreach ($soins as $donnees) {
                echo "<tr><td>";
                echo $donnees['typeExamen'];
                echo "</td><td>";
                echo $donnees['zoneCorporel'];
                echo "</td><td>";
                echo $donnees['dateExamen'];
                echo "</td></tr>";
            }
            echo "</table>";
        }
